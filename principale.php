...
if(isset($_POST['upload']))
{
    ...
    $sql4 = $bdd->query("INSERT INTO form_fil(id_user, NomEvent, Adresse, Ville, CP, id_image_event, TypeEvenement, Annonce, DateCreation, CptPouceBleu, CptPouceRouge, CptReport) VALUES ('$id_user','$nomevent','$lieu','$ville','$cp','$nb_ligne', '$checkboxes_string', '$annonce','$date','0','0','0')");
...
if(isset($_POST['Publier'])){
  ...
  $sql = "INSERT INTO commentaire_post (id_forum, id_user, commentaire_avis, DateCreationComment) VALUES ('68', '$id_user', '$commentaire', '$date')";
  $result = mysqli_query($bdd, $sql);
  $update = "UPDATE form_fil SET CptCommentaire = CptCommentaire + 1 WHERE id_forum = 2";
}
?>
            ...
            <div id="champ-remplit-art">
              ...
              <form method="post" action="principale.php" onsubmit="return checkForm(this);" enctype="multipart/form-data">
               <fieldset>
                  ...
                  <input type="text" name="NomEvent" id="NomEvent" placeholder="Exemple : Soirée mousse au Pop'Rock" size="50" required /><br /><br />
                  <label for="Lieu">Adresse de l'événement</label><br />
                  <input type="text" name="Adresse" id="Adresse" placeholder="Exemple : 120 Rue Ferdinand Buisson" size="50" required /><br /><br />
                  <label for="Ville">Ville</label><br />
                  <input type="text" name="Ville" id="Ville" placeholder="Exemple : Calais" size="50" required /><br /><br />
                  <label for="CP">Code postal</label><br />
                  <input type="number" name="CP" id="CP" placeholder="Exemple : 62100" required /><br /><br />
                </fieldset><br />
                <fieldset>
                  <legend>Image</legend>
                ...
                <br />
                <fieldset>
                  <legend>Choix du thème de l'evenement</legend>
